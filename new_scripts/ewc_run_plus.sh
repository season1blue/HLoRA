...
# D_DATASET="piqa"                                           # 支持 "medmcqa" "sciq" "piqa"           
MODEL_NAME="llama8B"                                             #可以选 "qwen","gptj","llama"                                              #正则化系数
########################################################################################

FISHER_MATRIX_PATH="weights/fisher-matrix/fisher-pile-llama3-8B" # Fisher矩阵目录
...
SCRIPT="EWC_run_plus.py"
LOG_FILE="log/ewclora_plus-$MODEL_NAME-r$LORA_RANK-C$REG_CONF-$B_DATASET->$C_DATASET.log"
OUTPUT_DIR="output/ewclora_plus-$MODEL_NAME-r$LORA_RANK-C$REG_CONF-$B_DATASET->$C_DATASET/checkpoint"     

...
SCRIPT="clora_run_plus.py"
LOG_FILE="log/clora_plus-$MODEL_NAME-r$LORA_RANK-C$REG_CONF-$B_DATASET->$C_DATASET.log"
OUTPUT_DIR="output/clora_plus-$MODEL_NAME-r$LORA_RANK-C$REG_CONF-$B_DATASET->$C_DATASET/checkpoint"     

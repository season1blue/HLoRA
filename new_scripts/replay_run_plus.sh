...
MODEL_NAME="gptj"                                             #可以选 "qwen","gptj","llama"                                              #正则化系数
########################################################################################
...
SCRIPT="replay_run_plus.py"
LOG_FILE="log/replay_plus-$MODEL_NAME-r$LORA_RANK-C$REG_CONF-$B_DATASET->$C_DATASET.log"
OUTPUT_DIR="output/replay_plus-$MODEL_NAME-r$LORA_RANK-C$REG_CONF-$B_DATASET->$C_DATASET/checkpoint"     

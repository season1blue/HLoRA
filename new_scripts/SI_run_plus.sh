...
# 可选参数
########################################################################################
B_DATASET="sciq"                                              # 支持 "medmcqa" "sciq" "piqa"
C_DATASET="piqa"                                              # 支持 "medmcqa" "sciq" "piqa"
# D_DATASET="sciq"                                           # 支持 "medmcqa" "sciq" "piqa"           
MODEL_NAME="llama8B"                                             #可以选 "qwen","gptj","llama"
REG_CONF=1e-3                                                 #正则化系数
# IS_LAYERWISE="true"                                         #"false" is no layerwise
########################################################################################
...
SCRIPT="SI_run_plus.py"
LOG_FILE="log/slora_plus-$MODEL_NAME-r$LORA_RANK-C$REG_CONF-$B_DATASET->$C_DATASET-layerwise.log"
OUTPUT_DIR="output/slora_plus-$MODEL_NAME-r$LORA_RANK-C$REG_CONF-$B_DATASET->$C_DATASET-layerwise/checkpoint"     

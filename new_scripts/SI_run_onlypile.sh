...
MODEL_NAME="llama3B"                                           #可以选 "qwen","gptj","llama"
REG_CONF=1e-3                                             #正则化系数
...
SCRIPT="SI_run_onlypile.py"
LOG_FILE="log/slora-$MODEL_NAME-pile-r$LORA_RANK-C$REG_CONF.log"
OUTPUT_DIR="output/slora-$MODEL_NAME-pile-r$LORA_RANK-C$REG_CONF/checkpoint"     

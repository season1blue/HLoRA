...
def sciq_dataloader(train_file, model_name_or_path="facebook/llama-7b", max_src_len=800, per_device_train_batch_size=8):
    # 1. 加载数据
    # 加载数据集并读取 JSON 文件
...
if __name__ == "__main__":
    train_file = "../datasets/SciQ/train.json"  # 训练数据文件路径
    train_dataloader = sciq_dataloader(train_file, model_name_or_path="../weights/gpt-j-6b", max_src_len=800, per_device_train_batch_size=8)
